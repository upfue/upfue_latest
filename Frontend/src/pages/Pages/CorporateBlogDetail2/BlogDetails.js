...
//import images
import Fliki from '../../../assets/video/Fliki.mp4';
            ...
            <Row>
              <Col lg={8} md={6}>
                <div className="me-lg-5">
                  ...
                  <h5 className="mt-4">
                    Fliki, text to speech video creation with synthetic voices.
                  </h5>

                  <p className="text-muted">
                    Fliki is a text-to-video rendering tool that uses AI to
                    create professional-sounding vocal tracks. With Fliki, you
                    can quickly turn any text into high-quality video or audio
                    files by selecting a voice from their extensive library of
                    male and female voices in multiple languages. This
                    eliminates the need for recording your own voice or hiring
                    expensive voice actors. Fliki is a versatile and easy-to-use
                    tool that can be used to create videos or audio files in any
                    language. It's perfect for promoting your business on social
                    media, creating educational videos, or adding some spice to
                    your content. Fliki is affordable, requires no technical
                    expertise, and is a great solution for content creators
                    worldwide.
                  </p>
                  <a>#AI&nbsp;</a>
                </div>
