  ...
  constructor(props) {
    ...
    this.state = {
      grid1: [
        ...
        { title: 'Gov Grants PSG', link: '/gov-grant-psg' },
        { title: 'Gov Grants EDG', link: '/gov-grant-edg' },
        { title: 'Job Positions', link: '/job' },
      ],
      grid2: [
        { title: 'Terms of Services', link: '/terms-conditions' },
                    ...
                    <Row>
                      <Col lg={4} className="col-12 mb-0 mb-md-4 pb-0 pb-md-2">
                        <Link to="#" className="logo-footer">
                          <img src={logolight} height="96" alt="" />
                        </Link>
                        <p className="mt-4">
                          DRIVING DIGITAL SUCCESS<br /> POWERING YOUR FUTURE
                        </p>
                ...
                <Row className="align-items-center">
                  <Col sm="6">
                    <div className="text-sm-start">
                      <p className="mb-0 text-uppercase">Upfue © {(new Date().getFullYear())}</p>
                    </div>
                  </Col>
