...
class TeamPage extends Component {
    constructor(props) {
        ...
        this.state = {
            candidates: [
                {
                    id: 1, image: team1, name: "Ko Kee Ching", designation: "C.E.O", salary: "2300", link: "",
                    socialIds: [
                        { icon: "facebook", link: "#" },
                        { icon: "instagram", link: "#" },
                        { icon: "twitter", link: "#" },
                ...
                {
                    id: 2, image: team2, name: "Eric Lee", designation: "Director", salary: "1950", link: "",
                    socialIds: [
                        { icon: "facebook", link: "#" },
                        { icon: "instagram", link: "#" },
                        { icon: "twitter", link: "#" },
                ...
                {
                    id: 3, image: team3, name: "Jasmine May", designation: "Human Resource", salary: "2540", link: "",
                    socialIds: [
                        { icon: "facebook", link: "#" },
                        { icon: "instagram", link: "#" },
                        { icon: "twitter", link: "#" },
                ...
                {
                    id: 4, image: team4, name: "Jasmine Wang", designation: "Human Resource", salary: "2190", link: "",
                    socialIds: [
                        { icon: "facebook", link: "#" },
                        { icon: "instagram", link: "#" },
                        { icon: "twitter", link: "#" },
                ...
                {
                    id: 5, image: team5, name: "ShuYangChen", designation: "IT Developer", salary: "2190", link: "",
                    socialIds: [
                        { icon: "facebook", link: "#" },
                        { icon: "instagram", link: "#" },
                        { icon: "twitter", link: "#" },
                ...
                {
                    id: 6, image: team6, name: "Venita Tan", designation: "Coordinator", salary: "2190", link: "",
                    socialIds: [
                        { icon: "facebook", link: "#" },
                        { icon: "instagram", link: "#" },
                        { icon: "twitter", link: "#" },
                ...
                {
                    id: 7, image: team7, name: "LiuJingYi", designation: "Graphic Designer", salary: "2190", link: "",
                    socialIds: [
                        { icon: "facebook", link: "#" },
                        { icon: "instagram", link: "#" },
                        { icon: "twitter", link: "#" },
                ...
                {
                    id: 8, image: team8, name: "Emily Leong", designation: "Content Creator", salary: "2190", link: "",
                    socialIds: [
                        { icon: "facebook", link: "#" },
                        { icon: "instagram", link: "#" },
                        { icon: "twitter", link: "#" },
