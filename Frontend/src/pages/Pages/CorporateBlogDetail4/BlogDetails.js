            ...
            <Row>
              <Col lg={8} md={6}>
                <div className="me-lg-5">
                  ...
                  <h5 className="mt-4">
                    Descript, edit videos as easy as using docs or slides
                  </h5>

                  <p className="text-muted">
                    Descript is a user-friendly platform that enables podcasters
                    and videographers to transcribe and edit audio and video
                    quickly using intuitive drag-and-drop tools. The platform
                    was created as a spin-off from Mason's audio-guide business
                    Detour, which was acquired by Bose in 2018. Descript has
                    recently launched new features, including AI-powered editing
                    tools and a redesigned interface that simplifies content
                    creation tasks. Users can now access advanced features such
                    as background removal, multitrack screen recording, and free
                    stock media. Additionally, the new Scenes feature allows
                    users to break down their scripts into scenes and keep
                    voiceovers in sync with the script.
                  </p>
                  <a>#AI&nbsp;</a>
                </div>
              </Col>
