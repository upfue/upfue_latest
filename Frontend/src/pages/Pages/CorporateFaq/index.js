...
class CorporateFaq extends Component {
  constructor(props) {
    super(props);
    this.state = {
      pathItems: [
                  ...
                  <div className="accordion" id="accordionExample">
                      ...
                      <Collapse isOpen={this.state.col1}>
                        <CardBody>
                          <p className="text-muted mb-0 faq-ans">
                            Our hours are 24/7/365 for coverage, monitoring, and
                            management of all client IT systems. User help desk
                            hours are 9am-6 pm, Monday – Friday.
                          </p>
                        </CardBody>
                      </Collapse>
                    </Card>
                    ...
                    <Card className="border-0 rounded mb-2">
                      ...
                      <Collapse isOpen={this.state.col2}>
                        <CardBody>
                          <p className="text-muted mb-0 faq-ans">
                            Managed IT Services is essentially outsourcing your
                            computers, network and help desk support to a
                            vendor. IT services are based on the use of
                            information technology and support business
                            processes in the company. They are defined by a
                            combination of people, processes and technologies.
                            In this way, they define all hardware and software,
                            cloud and infrastructure components in the company.
                          </p>
                        </CardBody>
                      </Collapse>
                    </Card>
                    ...
                    <Card className="border-0 rounded mb-2">
                      ...
                      <Collapse isOpen={this.state.col3}>
                        <CardBody>
                          <p className="text-muted mb-0 faq-ans">
                            One of the biggest benefits of managed IT services
                            is the cost savings that businesses experience by
                            making business IT support costs more predictable
                            and manageable. A managed service approach will also
                            provide businesses with comprehensive security,
                            customised backup and recovery solutions, and
                            state-of-the-art cloud storage and hosting.
                          </p>
                        </CardBody>
                      </Collapse>
                    </Card>
                    ...
                    <Card className="border-0 rounded mb-0">
                      ...
                      >
                        ...
                        >
                          <h6 className="title mb-0 text-uppercase">
                            {' '}
                            Will I maintain full control over my business by
                            using your service?
                            <i
                              className={
                                this.state.col4
                      ...
                      <Collapse isOpen={this.state.col4}>
                        <CardBody>
                          <p className="text-muted mb-0 faq-ans">
                            Yes, absolutely.Rest assured that with us, you won't
                            surrender any control. On the contrary, you'll gain
                            additional flexibility by relieving time-consuming
