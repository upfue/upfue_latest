...
import Zyro from '../../../assets/video/Zyro.mp4';
            ...
            <Row>
              <Col lg={8} md={6}>
                <div className="me-lg-5">
                  ...
                  <h5 className="mt-4">Zyro, feature-rich website builder</h5>

                  <p className="text-muted">
                    Zyro is a user-friendly website builder that offers a
                    plethora of customisable templates to suit your brand. Its
                    AI tools facilitate the creation of a website with relevant
                    elements and content in no time. Additionally, Zyro's
                    integration with marketing and analytical tools ensures that
                    visitors are attracted, engaged, and attended to promptly
                    and accurately.
                  </p>

                  <p className="text-muted">
                    Unlimited bandwidth and storage are provided in all of
                    Zyro's plans, enhancing your website's speed and capacity.
                    These features are also available at heavily discounted
                    rates.
                  </p>
                  <p className="text-muted">
                    Business owners prefer the Zyro website builder due to its
                    exceptional features. With over a hundred customisable
                    templates and AI tools for content creation, Zyro saves time
                    and energy while driving traffic to your website and
                    enhancing customer relationships through SEO tools.
                  </p>
                  <a>#AI&nbsp;</a>
                </div>
              </Col>
