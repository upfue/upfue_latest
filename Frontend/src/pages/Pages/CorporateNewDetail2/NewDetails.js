            ...
            <Row>
              <Col lg={8} md={6}>
                <div className="me-lg-5">
                  ...
                  <h5 className="mt-4">
                    Quiet revolution of “boring AI”, taking over the golden era
                    of ChatGPT
                  </h5>

                  <p className="text-muted">
                    The emergence of ChatGPT signals a prosperous era for AI and
                    machine learning, which have the potential to revolutionise
                    various industries by enhancing predictive abilities,
                    achieving net-zero emissions, and accelerating drug
                    development.
                  </p>
                  <p className="text-muted">
                    Boring AI, or the "quiet revolution" of AI automation, is
                    transforming work processes in the background by automating
                    tedious and time-consuming tasks. Despite lacking the
                    glamour of generative AI, boring AI is crucial for improving
                    business operations such as supply chain optimisation and
                    fraud detection, and has the potential to save businesses
                    money and reduce errors. Boring AI technologies are
                    increasingly maturing and adaptable to various industries,
                    including highly regulated ones like banking, healthcare,
