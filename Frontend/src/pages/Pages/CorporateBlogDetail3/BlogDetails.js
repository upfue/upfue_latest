            ...
            <Row>
              <Col lg={8} md={6}>
                <div className="me-lg-5">
                  ...
                  <h5 className="mt-4">
                    InVideo, turning a script into a video
                  </h5>

                  <p className="text-muted">
                    InVideo is a video creation platform with over 5,000
                    customizable templates, an intuitive user interface, and
                    features such as emojis, animations, and a voiceover
                    facility. The platform also offers various aspect ratios and
                    male and female voices from different countries. Templates
                    are conveniently organised into categories such as intro and
                    logos, slideshow, business presentation, video
                    advertisement, webinars, promos, greetings, and listicles.
                  </p>
                  <a>#AI&nbsp;</a>
                </div>
              </Col>
